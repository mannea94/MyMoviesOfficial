...
public class AdapterFullCrew extends RecyclerView.Adapter<AdapterFullCrew.ViewHolder>{
    ...
    public AdapterFullCrew(Context context_, ArrayList<MyMovies> myMovies_, OnRowClickListener onRowClickListener_){
        context=context_;
        myMovies=myMovies_;
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        final MyMovies myMovie = myMovies.get(position);
            ...
            holder.character.setText(myMovie.getDepartment());
